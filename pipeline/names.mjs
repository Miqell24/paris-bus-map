...
export const RULES = { style: 'title', prefer: ['Moulin à Vent'],
  // the town shuttles print their names, not the feed's capitals
  keys: {
    'AMIBUS': 'Amibus', 'AUDONIE': 'Audonienne', 'BATIGNO': 'Batignolles', 'BIEVRES': 'Bièvre',
    'CHARONNE': 'Charonne', 'CHOISYBUS': 'Choisybus', 'EOLIEN': 'Éolien', 'MONTBUS': 'Montbus',
    "P'TIT BUS": "P'tit Bus", 'RIVER': 'River', 'THIAIS': 'Thiais', 'TILLBUS': 'Tillbus', 'VITAVIL': 'Vitavil',
  },
};
